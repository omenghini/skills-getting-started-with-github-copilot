...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training sessions and matches for soccer enthusiasts",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["nina@mergington.edu", "liam@mergington.edu"]
    },
    "Yoga Club": {
        "description": "Improve flexibility, strength, and mindfulness with yoga",
    ...
    "Drama Workshop": {
        "description": "Acting, improvisation, and stagecraft practice",
